...
$today=10000*date("Y")+100*date("n")+date("j");
 // edit booking settings
  if ($_GET['change_settings'] == 1){
    ...
    $nf  = check($_POST['fixed']);
    $lastHour = intval($_POST['lastHour']);
    $firstHour = intval($_POST['firstHour']);
   ...
   $r = mysql_query("UPDATE bases SET `deadline`='$deadline',`timezone`='$timezone',`max`='$max',`maxPrime`='$maxPrime',`booking`='$booking',`accept`='$accept',`emailNotify`='$emailNotify',`NF`='$nf',`lastHour`='$lastHour',`firstHour`='$firstHour' WHERE id='$idb'");
...
//loading bookings end
 ...
 echo"
 <div id=\"button_1\">Текушие бронирования</div><div id=\"button_3\">История бронирований</div></div>
 <div class=\"elemento\" >
   <div id=\"el_1\">";
...
if ($_GET['settings'] == "on"){
 ...
 print("
    <script>
      $(document).on(\"click\",\".notfixedon\",function(){
        if ($(\".nfset\").length !== 0) {
          return 0;
        }
        var parent = $(this).parent().parent().parent(),
        description = $(parent.children()[1]),
        input = $(parent.children()[2]);

        $(\"<div />\",{class : \"nfset\", html:\"<input type=\\\"text\\\" class=\\\"textinput\\\" style=\\\"width:200px\\\" name=\\\"firstHour\\\" />\"}).appendTo(input).css(\"padding-top\",\"10px\");
        $(\"<div />\",{class : \"nfset\", html:\"<input type=\\\"text\\\" class=\\\"textinput\\\" style=\\\"width:200px\\\" name=\\\"lastHour\\\" />\"}).appendTo(input);

        $(\"<div />\",{class : \"nfset\", html:\"Час открытия (24 формат):\"}).appendTo(description).css(\"padding-top\",\"20px\");
        $(\"<div />\",{class : \"nfset\", html:\"Час закрытия (24 формат):\"}).appendTo(description).css(\"padding-top\",\"14px\");
      });

   $(document).on(\"click\",\".fixedon\",function(){
          $(\".nfset\").remove();
        });
     </script>
  ");
  ...
  if (!$settings['NF']) {
    ...
    $ch4 = "";
    $ch5 = "checked=\"checked\"";
    $addInput = "<div class=\"nfset\" style=\"padding-top: 10px; \"><input type=\"text\" class=\"textinput\" style=\"width:200px\" name=\"firstHour\" value=\"".$settings['firstHour']."\"></div>
    <div class=\"nfset\"><input type=\"text\" class=\"textinput\" style=\"width:200px\" name=\"lastHour\" value=\"".$settings['lastHour']."\"></div>";
    $addDes = "<div class=\"nfset\" style=\"padding-top: 20px; \">Час открытия (24 формат):</div>
    <div class=\"nfset\" style=\"padding-top: 14px; \">Час закрытия (24 формат):</div>";
  }
  echo"
...
<div class=\"settingsBlock\">
  ...
  <div class=\"inputs\">
    ...
    <div>
      <input type=\"checkbox\" name=\"emailNotify\" value=\"1\" $ch7 />
    </div>
...
<div class=\"settingsBlock\">
  ...
  <div class=\"inputs\">
    ...
    <div style=\"padding-top: 16px\">
      <input type=\"radio\" class=\"fixedon\" name=\"fixed\" value=\"0\" $ch4/>
    </div>
    <div >
      <input type=\"radio\" class=\"notfixedon\" name=\"fixed\" value=\"1\" $ch5/>
    </div>
    ".$addInput."
  </div>
</div>
