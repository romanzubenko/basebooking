...
<script type="text/javascript" src="http://basebooking.ru/js/baseConstructorE.js"></script>
...
<script type="text/javascript" src="http://basebooking.ru/js/bookingEngineE.js"></script>
</head>
<body>
...
<div class="space"></div>
  <div id="basename">
    <?php $b = clears($_GET['name']); echo $b;?>
    <div id="about">
      English prototype. Simple and elegant way to set up online booking for your recording or rehersal studio.    
    </div>
