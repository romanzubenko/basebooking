...
$adminPanel = "";
  ...
  "; 
   if (isset($_SESSION['login']) && $_SESSION['login']!="superadmin") {
    $adminPanel .="
      <div id=\"admin_panel\">
        <a href=\"http://www.basebooking.ru/admin\">Мой кабинет </a>
        <a href=\"http://www.basebooking.ru/exit.php\">Выйти</a>
      </div>";
      //
  } else if (isset($_SESSION['vkid'])) {
    $adminPanel .="
      <div id=\"admin_panel\">
        <a href=\"http://www.basebooking.ru/musician\">Мой кабинет</a>
        <a href=\"http://www.basebooking.ru/exit.php\">Выйти</a>
      </div>";
     ...
     $adminPanel .="
      <div id=\"admin_panel\">
        <a href=\"http://www.basebooking.ru/superadmin\">Мой кабинет</a>
        <a href=\"http://www.basebooking.ru/exit.php\">Выйти</a>
      </div>";
  } else {
      $adminPanel .="
        <div id=\"admin_panel\" style=\"width:118px;\">
          <a href=\"http://www.basebooking.ru/enter\" style=\"width:118px;border-right: none \"> Вход в кабинет</a>
        </div>";
  }
